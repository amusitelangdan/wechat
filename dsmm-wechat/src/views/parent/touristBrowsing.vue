    ...
    <mt-swipe :auto="0" :prevent="true" :continuous="false">
      <mt-swipe-item style="overflow:hidden;background: #26C881">
        <div style="width: 100%;position: relative;">
          <img src="../../assets/img/icon/touristBrowsing/browsing_one.png" alt="" style="transform: translate(-50%,0);position: absolute;top: 0;left: 50%;" ref="homePage1">
        </div>
      </mt-swipe-item>
      <mt-swipe-item style="overflow:hidden;background: #3EC4E9">
        <div style="width: 100%;position: relative;">
          <img src="../../assets/img/icon/touristBrowsing/browsing_two.png" alt="" style="transform: translate(-50%,0);position: absolute;top: 0;left: 50%;" ref="homePage2">
        </div>
      </mt-swipe-item>
      <mt-swipe-item style="overflow:hidden;background: #FFAB33">
        <div style="width: 100%;position: relative;">
          <img src="../../assets/img/icon/touristBrowsing/browsing_three.png" alt="" style="transform: translate(-50%,0);position: absolute;top: 0;left: 50%;" ref="homePage3">
        </div>
      </mt-swipe-item>
    </mt-swipe>
  </div>
