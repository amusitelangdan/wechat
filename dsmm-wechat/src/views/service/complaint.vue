  ...
  <div>
    ...
    <div class="card">
      <div class="card-cell_link">
        <div @click="selection"><span>{{feedbackTypeName}}</span><span v-if="!feedbackTypeName" class="color-info">请选择举报类型</span></div>
      </div>
      ...
      <div class="card-cell" style="padding: 0;">
        <div v-if="phone" class="input_line" style="line-height: 100%;border: 0;">{{phone}}</div>
